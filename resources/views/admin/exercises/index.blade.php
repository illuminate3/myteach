...
@section('js')
    ...
    <script src="{{asset('js/admin/app/services/homeworksFactory.js')}}"></script>
    <script src="{{asset('js/admin/app/controller/homeworksController.js')}}"></script>
    <script src="{{asset('js/admin/app/controller/homeworksCreateController.js')}}"></script>
    <script src="{{asset('js/admin/app/controller/homeworksEditController.js')}}"></script>
