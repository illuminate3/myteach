angular.module('teacherApp')
    .controller('farsiController', function($scope,$http,$window) {
        ...
        $scope.pageArticle = function () {
            $http.post('/admin/persian',JSON.stringify({'description' : $scope.tinymceModel}))
                .success(function () {
